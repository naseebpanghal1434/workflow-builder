/**
 * @fileoverview Text input node component
 * @module Components/Nodes/TextNode
 */
 ...
 */
interface TextNodeDataWithHandler extends TextNodeData {
...
/**
 * TextNode - Node for text input with output handle
 *
 * @component
 * @param {NodeProps<TextNodeDataWithHandler>} props - Node props from React Flow
 * @returns {ReactElement} Rendered text node
 *
 * @example
...
function TextNodeComponent({
  data,
  selected,
}: NodeProps<TextNodeDataWithHandler>): ReactElement {
  /**
   * Handle text change
   */
  ...
  return (
    <NodeWrapper selected={selected}>
      ...
      <Handle
        ...
        style={{ top: '50%', right: '-15px', background: '#F1A0FA' }}
      />
    </NodeWrapper>
  );
}
